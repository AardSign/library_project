...
public class LivroDAO {
 ...
 // Listar livros disponíveis
    ...
    public int buscarLivroIdPorCodigoDeBarras(String codigoDeBarras) throws SQLException {
        String sql = "SELECT id FROM Livros WHERE codigo_barras = ?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    throw new IllegalArgumentException("Livro não encontrado com o código de barras: " + codigoDeBarras);
                }
            }
        }
    }
